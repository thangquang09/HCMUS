...
class Solution():
    ...
    def __init__(self):
        ...
        # Each state gives the number of missionaires and cannibals on the left side
        ...
        self.graph = pydot.Dot(
            graph_type="graph",
            bgcolor="#fff3af",
            label="fig: Missionaires and Cannibal State Space Tree",
            fontcolor="red",
            fontsize="24"
        )
        self.visited = {}
    ...
    def draw_legend(self):
        ...
        description = "Each node (m, c, s) represents a \nstate where 'm' is the number of missionaries,\n" \
        ...
        node6 = pydot.Node("6", style="filled", label=description, shape="plaintext", fontsize="20", fontcolor="red")
    ...
    def bfs(self):
        ...
        while q:
            ...
            for x, y in self.options:
                ...
                if (next_m, next_c, next_s) not in self.visited and self.is_valid_move(next_m, next_c):
